...
/** Кликабельные ники → досье (дублирует js/player-links.js для синхронной загрузки). */
(function (root, factory) {
    ...
    return { escapePlayerLinkText, dossierUrl, playerEmailFromFighterId, playerNameHtml, playerNameLink };
});
